...
async def send_sms(location_id: str, contact_id: str, message: str, api_key: str, phone: Optional[str] = None) -> bool:
...
async def get_conversations(location_id: str, contact_id: str, api_key: str) -> Optional[list]:
    """Get existing conversations for a GHL contact."""
...
async def trigger_workflow(location_id: str, contact_id: str, workflow_id: str, api_key: str) -> bool:
    """Fire a GHL workflow for a contact (e.g. for calendar/follow-up)."""
